 ...
 *  - v1.3 (2026): `techTiles` extended again from the same Stream/Edge Sources overview pages
 *    plus Cribl Stream 4.18.0 release notes (new Pull/Push/System sources: Anthropic Compliance API,
 *    Okta, OpenAI Compliance Logs, Azure Event Hubs AMQP, ServiceNow Table API; Push: Cloudflare,
 *    Metrics, Model Driven Telemetry; System: Datagen, Exec, File Monitor; Edge: Prometheus Edge Scraper).
 *  - v1.3 (2026): `destTiles` refreshed against Stream/Edge Destinations overviews and Stream 4.18.0
 *    (S3-compatible additions: Alibaba OSS, AlphaSOC, Cloudian HyperStore, Dell PowerScale OneFS,
 *    Nutanix Objects, Scality, Storj).
...
export const inputData = {
  techTiles: [
    ...
    'Okta',
    'OpenAI',
    'OpenAIComplianceLogs',
    'OpenTelemetry',
    'Prometheus',
    'PrometheusEdgeScraper',
...
/**
 * Terms customers commonly use when searching for a source tile. These aliases
 * only affect typeahead matching; picking an option still stores the canonical
 * Cribl tile name from `inputData.techTiles`.
 */
export const sourceTileSearchAliases = {
  ...
  Datagen: ['Data gen'],
  Exec: ['Exec source'],
  FileMonitor: ['File Monitor', 'file monitor'],
  Metrics: ['Metrics source', 'generic metrics'],
  ModelDrivenTelemetry: ['MDT', 'Model-Driven Telemetry', 'gNMI'],
  Okta: ['Okta logs', 'Okta system log'],
  OpenAIComplianceLogs: [
    'OpenAI Compliance',
    'ChatGPT Enterprise compliance',
    'OpenAI compliance logs',
  ],
  PrometheusEdgeScraper: ['Prometheus Edge', 'Edge Prometheus scraper'],
  ServiceNowTableAPI: ['ServiceNow Table', 'ServiceNow table API', 'Table API'],
  SplunkTCP: [
    'Splunk UF',
    'SplunkUF',
    'Universal Forwarder',
